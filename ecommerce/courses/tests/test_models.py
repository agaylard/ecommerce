...
class CourseTests(CourseCatalogTestMixin, TestCase):
    ...
    def test_professional_course_verification_update_with_no_order(self):
        """
        Verify that when professional-course is updated with id_verification_required it will leaves no
        stale products.
        """
    ...
    def test_professional_course_verification_update_with_orders(self):
        """
        Verify that when professional-course is updated with id_verification_required but having orders it will remain
        in system.
        """
        user = self.create_user()
        course = CourseFactory()
